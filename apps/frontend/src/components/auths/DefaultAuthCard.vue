...
<template>
  <!-- ====== Forms Section Start -->
  <div
    class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark my-auto flex flex-col"
  >
        ...
        <div class="py-17.5 px-26 text-center">
          <router-link class="mb-5.5 inline-block" to="/">
            <img
              ...
              src="https://turkai.com/wp-content/uploads/2023/01/logo.turkai.white_.png"
              alt="Logo"
            />
            <img
              class="dark:hidden"
